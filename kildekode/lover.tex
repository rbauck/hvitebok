...
%\Large Ajour vårsemesteret 2005}
...
\Large Disse lovene er ajour vårsemesteret 2005.
...
\item[f)] Hovedstyret kan bestemme at andre styrer og utvalg selv kan
knytte til seg inntil et bestemt antall funkjsonærer for å utføre
...
\item[b)] Valgbare er alle som har hatt valgte verv som nevnt i §20 l).
...
ikke kommer inn under §14 d) under første punkt. Generalforsamlingen er
...
§20 l).  Den endelige dagsorden godkjennes av generalforsamlingen.  I
...
medlemmer, med de innskrenkninger som følger av §13 b), §14 b) og c) og 
§15 b).
...
\item[l)] På ordinær generalforsamling behandles:
	...
	\item[6.] Valg av tillitsvalgte: 
		...
		\item[6c)] Arrangementsjef (§8b) 

		\item[6d)] Fagsjef (§8b) 

		\item[6e)] Kjellermester(§8b) 

		\item[6f)] Informasjonssjef (§8b) 

		\item[6g)] Kafesjef (§12a) 

		\item[6h)] To Skjenkemestre (§12a)

		\item[6i)] To medlemmer til Økonomiutvalget (§13a)

		\item[6j)] Leder av Økonomiutvalget (§13a) 

		\item[6k)] Ett medlem til Desisjonsutvalget (§14a) 

		\item[6l)] Minst ett medlem til Revisjonsutvalget (§15a) 

		\item[6m)] Formann i Regi (§16a) 

		\item[6n)] Forretningsforfører i Regi (§16a) 
		\end{itemize}
	\end{itemize}
\end{itemize}
