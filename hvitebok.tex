...
Urlen til hviteboken ligger på svn+ssh://login.ifi.uio.no/mn/sarpanitu/studenter-u3/rf/hb/
Man må ligge i filgruppen til RF for å få tilgang. Tilgang kan man få ved å 
kontakte Hovedstyret.

\subsection{Skaffe tilgang til filene}
...
\subsection{Oppdatere databasen}
